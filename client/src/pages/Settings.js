        ...
        <Grid container spacing={3} justifyContent={"center"}>
          ...
          <Grid item xs={12} md={6}>
            <Card className="shadow-lg border-0 rounded-4 card-hover">
              <CardContent>
                <Typography variant="h6" className="fw-bold text-primary mb-2">
          ...
          <Grid item xs={12} md={6}>
            <Card className="shadow-lg border-0 rounded-4 card-hover">
              <CardContent>
                <Typography variant="h6" className="fw-bold text-danger mb-2">
          ...
          <Grid item xs={12}>
            <Card className="shadow-lg border-0 rounded-4 card-hover">
              <CardContent>
                <Typography variant="h6" className="fw-bold text-warning mb-2">
